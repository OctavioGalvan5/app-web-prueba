...
from services.calculos import transformar_fecha
...
from services.consultas.consultas import openai_api_extract_data, update_cliente_in_db, process_file, FORMULARIOS_MAPPING
# Entities
...
# Blueprint: Escritos de Liquidación
...
def upload_dni():
    ...
    # Procesar cada archivo recibido (process_file retorna lista de páginas)
    processed_files = []
    ...
    # Enviar todas las páginas a la API de OpenAI
...
# =====================================================================
# RUTAS ANTIGUAS DE ESCRITOS DE LIQUIDACIÓN — REEMPLAZADAS POR BLUEPRINT
# Las nuevas rutas están en blueprints/escritos_liquidacion/routes.py
# =====================================================================
# @app.route('/generador_escrito_liquidacion', methods=['GET', 'POST'])
# def generador_escrito_liquidacion_OLD():
#     if request.method == 'POST':
